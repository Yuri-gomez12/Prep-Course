...
* Funciones Callback = crear una funcion ess pasandola como parametro a otra funcion y luego llamarla de vuelta justo despúes de que haya ocurrido algo o se haya completado alguna tarea.
