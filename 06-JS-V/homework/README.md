...
* `prototype` =mecanismos  de los objetos en JavaScript heredan caracteristicas entre si 
* _Constructors_ (de Clases) =es un metodo especial para crear e inicializar un objeto creado a partir de una clase 
